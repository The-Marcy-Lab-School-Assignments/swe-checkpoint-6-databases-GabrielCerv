...
WHERE posts.title =  'Getting Started with SQL';
...
INNER JOIN post_tags ON post_tags.post_id = posts.post_id
INNER JOIN tags ON tags.tag_id = post_tags.tag_id
...
VALUES('grace_h','grace@example.com');
